...
推送到 GitHub `main` 分支后，GitHub Actions 会自动运行 `Package MaoqiuPlayer` 工作流，构建并上传临时 artifacts。推送 `v*` 标签后，工作流会创建 GitHub Release 并上传正式发布包：

- `MaoqiuPlayer-macOS.dmg`
- `MaoqiuPlayer-Windows.exe`
- `MaoqiuPlayer-Linux.tar.gz`
